Rails.application.configure do
  ...
  config.action_mailer.asset_host          = "https://https://team12.demo2.genesys.shefcompsci.org.uk/"
  ...
  # config.active_job.queue_name_prefix = "fitness-for-students_#{Rails.env}"
